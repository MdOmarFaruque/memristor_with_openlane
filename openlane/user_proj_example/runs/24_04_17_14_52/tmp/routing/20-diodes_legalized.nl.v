module user_proj_example (SEL2,
 ...
 sky130_fd_sc_hd__buf_4 input1 (.A(analog_io1),
    .X(net1));
 sky130_fd_sc_hd__clkbuf_8 input2 (.A(analog_io3),
    .X(net2));
 sky130_fd_sc_hd__buf_2 input3 (.A(io_in[0]),
    .X(net3));
 sky130_fd_sc_hd__buf_4 input4 (.A(io_in[1]),
    .X(net4));
 sky130_fd_sc_hd__clkbuf_4 input5 (.A(io_in[2]),
    .X(net5));
 sky130_fd_sc_hd__buf_4 input6 (.A(io_in[3]),
    .X(net6));
 sky130_fd_sc_hd__buf_8 input7 (.A(io_in[4]),
    .X(net7));
