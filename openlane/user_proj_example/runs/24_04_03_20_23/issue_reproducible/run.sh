...
export CURRENT_DEF='./tmp/cts/15-user_proj_example.resized.def';
export CURRENT_NETLIST='./tmp/cts/15-user_proj_example.resized.nl.v';
export CURRENT_ODB='./tmp/cts/15-user_proj_example.resized.odb';
export CURRENT_POWERED_NETLIST='./tmp/cts/15-user_proj_example.resized.pnl.v';
export CURRENT_SDC='./tmp/cts/15-user_proj_example.resized.sdc';
...
export FP_PDN_MACRO_HOOKS='core_flat vdda1 vssa1 vdda1 vssa1';
...
export PACKAGED_SCRIPT_7='./tmp/cts/15-user_proj_example.resized.sdc';
export PACKAGED_SCRIPT_8='./tmp/16-user_proj_example.sdc';
...
export SAVE_DEF='./tmp/16-user_proj_example.def';
export SAVE_NETLIST='./out.v';
export SAVE_ODB='./tmp/16-user_proj_example.odb';
export SAVE_POWERED_NETLIST='./tmp/16-user_proj_example.pnl.v';
export SAVE_SDC='./tmp/16-user_proj_example.sdc';
