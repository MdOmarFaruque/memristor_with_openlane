...
set env CURRENT_DEF ./tmp/cts/15-user_proj_example.resized.def
set env CURRENT_NETLIST ./tmp/cts/15-user_proj_example.resized.nl.v
set env CURRENT_ODB ./tmp/cts/15-user_proj_example.resized.odb
set env CURRENT_POWERED_NETLIST ./tmp/cts/15-user_proj_example.resized.pnl.v
set env CURRENT_SDC ./tmp/cts/15-user_proj_example.resized.sdc
...
set env PACKAGED_SCRIPT_7 ./tmp/cts/15-user_proj_example.resized.sdc
set env PACKAGED_SCRIPT_8 ./tmp/16-user_proj_example.sdc
...
set env SAVE_DEF ./tmp/16-user_proj_example.def
set env SAVE_NETLIST ./out.v
set env SAVE_ODB ./tmp/16-user_proj_example.odb
set env SAVE_POWERED_NETLIST ./tmp/16-user_proj_example.pnl.v
set env SAVE_SDC ./tmp/16-user_proj_example.sdc
