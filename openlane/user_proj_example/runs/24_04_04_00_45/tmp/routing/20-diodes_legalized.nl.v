module user_proj_example (SEL2,
 ...
 sky130_fd_sc_hd__buf_8 input8 (.A(io_in[4]),
    .X(net8));
 sky130_fd_sc_hd__diode_2 ANTENNA_core_flat_SEL2 (.DIODE(SEL2));
 sky130_fd_sc_hd__diode_2 ANTENNA_core_flat_AIN1 (.DIODE(net1));
 sky130_fd_sc_hd__diode_2 ANTENNA_core_flat_AIN2 (.DIODE(net2));
 sky130_fd_sc_hd__diode_2 ANTENNA_core_flat_AIN3 (.DIODE(net3));
 sky130_fd_sc_hd__diode_2 ANTENNA_core_flat_SEL1 (.DIODE(net4));
 sky130_fd_sc_hd__diode_2 ANTENNA_core_flat_DIGITALIN1 (.DIODE(net5));
 sky130_fd_sc_hd__diode_2 ANTENNA_core_flat_SEL3 (.DIODE(net6));
 sky130_fd_sc_hd__diode_2 ANTENNA_core_flat_DIGITALIN3 (.DIODE(net7));
 sky130_fd_sc_hd__diode_2 ANTENNA_core_flat_DIGITALIN2 (.DIODE(net8));
endmodule
