module user_proj_example (SEL2,
 ...
 sky130_fd_sc_hd__buf_6 input1 (.A(SEL2),
    .X(net1));
 sky130_fd_sc_hd__buf_4 input2 (.A(analog_io1),
    .X(net2));
 sky130_fd_sc_hd__buf_4 input3 (.A(analog_io3),
    .X(net3));
 sky130_fd_sc_hd__clkbuf_4 input4 (.A(io_in[0]),
    .X(net4));
 sky130_fd_sc_hd__buf_4 input5 (.A(io_in[1]),
    .X(net5));
 sky130_fd_sc_hd__clkbuf_2 input6 (.A(io_in[2]),
    .X(net6));
 sky130_fd_sc_hd__clkbuf_4 input7 (.A(io_in[3]),
    .X(net7));
 sky130_fd_sc_hd__buf_12 input8 (.A(io_in[4]),
    .X(net8));
 ...
 sky130_fd_sc_hd__diode_2 ANTENNA_core_flat_v4_AIN1 (.DIODE(net2));
