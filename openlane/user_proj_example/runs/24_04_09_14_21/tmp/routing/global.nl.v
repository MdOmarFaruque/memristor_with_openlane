module user_proj_example (SEL2,
 ...
 sky130_fd_sc_hd__diode_2 ANTENNA_core_flat_AIN1 (.DIODE(analog_io1));
 sky130_fd_sc_hd__diode_2 ANTENNA_core_flat_AIN2 (.DIODE(analog_io2));
 sky130_fd_sc_hd__diode_2 ANTENNA_core_flat_AIN3 (.DIODE(analog_io3));
 sky130_fd_sc_hd__diode_2 ANTENNA_core_flat_SEL1 (.DIODE(net1));
 sky130_fd_sc_hd__diode_2 ANTENNA_core_flat_DIGITALIN1 (.DIODE(net2));
 sky130_fd_sc_hd__diode_2 ANTENNA_core_flat_SEL3 (.DIODE(net3));
 sky130_fd_sc_hd__diode_2 ANTENNA_core_flat_DIGITALIN3 (.DIODE(net4));
 sky130_fd_sc_hd__diode_2 ANTENNA_core_flat_DIGITALIN2 (.DIODE(net5));
endmodule
