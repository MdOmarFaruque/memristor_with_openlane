module user_proj_example (SEL2,
 ...
 core_flat_v4 core_flat_v4 (.SEL1(net3),
    .DIGITALIN1(net4),
    .AIN1(net1),
    .SEL3(net5),
    .DIGITALIN3(net6),
 ...
 sky130_fd_sc_hd__buf_4 input1 (.A(analog_io1),
    .X(net1));
 sky130_fd_sc_hd__buf_4 input2 (.A(analog_io3),
    .X(net2));
 sky130_fd_sc_hd__clkbuf_4 input3 (.A(io_in[0]),
    .X(net3));
 sky130_fd_sc_hd__buf_4 input4 (.A(io_in[1]),
    .X(net4));
 sky130_fd_sc_hd__clkbuf_2 input5 (.A(io_in[2]),
    .X(net5));
 sky130_fd_sc_hd__clkbuf_4 input6 (.A(io_in[3]),
    .X(net6));
 sky130_fd_sc_hd__buf_12 input7 (.A(io_in[4]),
    .X(net7));
 ...
 sky130_fd_sc_hd__diode_2 ANTENNA_core_flat_v4_AIN3 (.DIODE(net2));
 sky130_fd_sc_hd__diode_2 ANTENNA_core_flat_v4_SEL1 (.DIODE(net3));
 sky130_fd_sc_hd__diode_2 ANTENNA_core_flat_v4_DIGITALIN1 (.DIODE(net4));
 sky130_fd_sc_hd__diode_2 ANTENNA_core_flat_v4_SEL3 (.DIODE(net5));
 sky130_fd_sc_hd__diode_2 ANTENNA_core_flat_v4_DIGITALIN3 (.DIODE(net6));
 sky130_fd_sc_hd__diode_2 ANTENNA_core_flat_v4_DIGITALIN2 (.DIODE(net7));
endmodule
