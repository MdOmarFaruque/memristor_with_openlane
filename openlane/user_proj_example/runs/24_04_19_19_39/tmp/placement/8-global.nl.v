module user_proj_example (SEL2,
 ...
 sky130_fd_sc_hd__conb_1 _0_ (.HI(io_oeb[0]));
 sky130_fd_sc_hd__conb_1 _1_ (.HI(io_oeb[1]));
 sky130_fd_sc_hd__conb_1 _2_ (.HI(io_oeb[2]));
 sky130_fd_sc_hd__conb_1 _3_ (.HI(io_oeb[3]));
 sky130_fd_sc_hd__conb_1 _4_ (.HI(io_oeb[4]));
 sky130_fd_sc_hd__conb_1 _5_ (.HI(io_oeb[5]));
 sky130_fd_sc_hd__conb_1 _6_ (.HI(io_oeb[6]));
 sky130_fd_sc_hd__conb_1 _7_ (.HI(io_oeb[7]));
 sky130_fd_sc_hd__conb_1 _8_ (.HI(io_oeb[8]));
 core_flat_v4 core_flat_v4 (.SEL1(io_in[0]),
    .DIGITALIN1(io_in[1]),
    .AIN1(analog_io1),
    .SEL3(io_in[2]),
    .DIGITALIN3(io_in[3]),
