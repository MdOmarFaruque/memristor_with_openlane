module user_proj_example (SEL2,
 ...
 sky130_fd_sc_hd__conb_1 user_proj_example_8 (.HI(net8));
 sky130_fd_sc_hd__conb_1 user_proj_example_9 (.HI(net9));
 sky130_fd_sc_hd__conb_1 user_proj_example_10 (.HI(net10));
 sky130_fd_sc_hd__conb_1 user_proj_example_11 (.HI(net11));
 sky130_fd_sc_hd__conb_1 user_proj_example_12 (.HI(net12));
 sky130_fd_sc_hd__conb_1 user_proj_example_13 (.HI(net13));
 sky130_fd_sc_hd__conb_1 user_proj_example_14 (.HI(net14));
 sky130_fd_sc_hd__conb_1 user_proj_example_15 (.HI(net15));
 sky130_fd_sc_hd__diode_2 ANTENNA_core_flat_v4_AIN1 (.DIODE(analog_io1));
 core_flat_v4 core_flat_v4 (.SEL1(net2),
    .DIGITALIN1(net3),
    .AIN1(analog_io1),
    .SEL3(net4),
    .DIGITALIN3(net5),
 ...
 sky130_fd_sc_hd__buf_4 input1 (.A(SEL2),
    .X(net1));
 sky130_fd_sc_hd__buf_2 input2 (.A(io_in[0]),
    .X(net2));
 sky130_fd_sc_hd__clkbuf_4 input3 (.A(io_in[1]),
    .X(net3));
 sky130_fd_sc_hd__clkbuf_2 input4 (.A(io_in[2]),
    .X(net4));
 sky130_fd_sc_hd__clkbuf_2 input5 (.A(io_in[3]),
    .X(net5));
 sky130_fd_sc_hd__clkbuf_8 input6 (.A(io_in[4]),
    .X(net6));
 sky130_fd_sc_hd__conb_1 user_proj_example_7 (.HI(net7));
 sky130_fd_sc_hd__diode_2 ANTENNA_core_flat_v4_AIN2 (.DIODE(analog_io2));
 sky130_fd_sc_hd__diode_2 ANTENNA_core_flat_v4_AIN3 (.DIODE(analog_io3));
 sky130_fd_sc_hd__diode_2 ANTENNA_core_flat_v4_SEL2 (.DIODE(net1));
 sky130_fd_sc_hd__diode_2 ANTENNA_core_flat_v4_SEL1 (.DIODE(net2));
 sky130_fd_sc_hd__diode_2 ANTENNA_core_flat_v4_DIGITALIN1 (.DIODE(net3));
 sky130_fd_sc_hd__diode_2 ANTENNA_core_flat_v4_SEL3 (.DIODE(net4));
 sky130_fd_sc_hd__diode_2 ANTENNA_core_flat_v4_DIGITALIN3 (.DIODE(net5));
 sky130_fd_sc_hd__diode_2 ANTENNA_core_flat_v4_DIGITALIN2 (.DIODE(net6));
